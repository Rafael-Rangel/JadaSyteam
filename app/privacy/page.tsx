      ...
      <main className="flex-grow py-12 bg-neutral-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-8 space-y-6">
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">1. Informações que Coletamos</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">2. Como Usamos suas Informações</h2>
              <p className="text-neutral-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">3. Compartilhamento de Informações</h2>
              <p className="text-neutral-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">4. Segurança</h2>
              <p className="text-neutral-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">5. Seus Direitos</h2>
              <p className="text-neutral-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">6. Alterações nesta Política</h2>
              <p className="text-neutral-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">7. Contato</h2>
              <p className="text-neutral-700 leading-relaxed">
