    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow py-12 bg-neutral-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-neutral-900 mb-8">Termos de Uso</h1>
          
          <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-8 space-y-6">
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">1. Aceitação dos Termos</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">2. Uso da Plataforma</h2>
              <p className="text-neutral-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">3. Contas de Usuário</h2>
              <p className="text-neutral-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">4. Assinaturas e Pagamentos</h2>
              <p className="text-neutral-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">5. Limitação de Responsabilidade</h2>
              <p className="text-neutral-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">6. Propriedade Intelectual</h2>
              <p className="text-neutral-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">7. Modificações dos Termos</h2>
              <p className="text-neutral-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">8. Contato</h2>
              <p className="text-neutral-700 leading-relaxed">
